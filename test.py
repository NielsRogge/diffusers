...
def get_docstring_from_class(class_name):
    try:
        if '.' in class_name:
            # For any class in diffusers (e.g. models.ernie.modeling_ernie.ErnieForPreTrainingOutput or pipelines.ArgumentHandler)
            first_part = class_name.split('.')[0]
            module_path = f'diffusers.{first_part}'
            ...
            # Try importing directly from diffusers as fallback
...
if __name__ == "__main__":
    # Add the diffusers source directory to the Python path
    import sys
